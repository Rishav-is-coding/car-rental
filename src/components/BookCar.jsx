              ...
              <form className="box-form">
                ...
                <div className="box-form__car-type">
                  ...
                  <select value={pickUp} onChange={handlePick}>
                    ...
                    <option>Pick on Site</option>
                    <option>Fancy</option>
                    <option>GS Road</option>
                    <option>North Guwahati</option>
                    <option>Khanapara</option>
                    <option>Hathigaon</option>
                ...
                <p>*Reserving from your desired location costs extra <span>200 Rs</span></p>
        ...
        <div className="booking-modal__person-info">
          ...
          <form className="info-form">
            ...
            <span className="info-form__checkbox">
              ...
              <p>Include driver</p> <br/>
            </span>
            <p>* Driver costs extra 3500 Rs per day</p>
